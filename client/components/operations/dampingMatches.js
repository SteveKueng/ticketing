    ...
    if (measurementsA.length <= measurementsB.length) {
        measurementMatches = measurementsA.map(measureA => {
            ...
            return {
                ...
                AtoBDamping: matchMeasureB.measure.rxValue - (measureA.txValue - 22),
                BtoADamping: measureA.rxValue - (matchMeasureB.measure.txValue- 22),
                dateA: measureA.date,
        ...
        measurementMatches = measurementsB.map(measureB => {
            ...
            return {
                ...
                AtoBDamping: measureB.rxValue - (matchMeasureA.measure.txValue - 22),
                BtoADamping: matchMeasureA.measure.rxValue - (measureB.txValue - 22),
